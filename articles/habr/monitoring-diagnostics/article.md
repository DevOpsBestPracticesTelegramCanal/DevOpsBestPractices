...
## Введение: Зачем нужна диагностика

Развертывание системы мониторинга может завершиться неудачей из-за неготовности инфраструктуры. Типичные сценарии: Prometheus не запускается из-за занятого порта 9090, останавливается через несколько дней из-за исчерпания файловых дескрипторов, или Grafana теряет данные при перезапуске из-за неправильно настроенных volumes.
