"""
Tests for DevOps external validators (Week 16).
...
class TestDetectContentType:
    ...
    def test_docker_compose_is_yaml_not_ansible(self):
        """Docker Compose should be yaml, not misdetected as ansible."""
        code = "version: '3.8'\nservices:\n  db:\n    image: postgres\n"
...
class TestFactoryFunctions:
    ...
    def test_devops_external_rules_returns_6(self):
...
class TestRegistryIntegration:
    ...
    def test_devops_validators_in_registry(self):
        ...
        # They are registered via try/except ImportError
